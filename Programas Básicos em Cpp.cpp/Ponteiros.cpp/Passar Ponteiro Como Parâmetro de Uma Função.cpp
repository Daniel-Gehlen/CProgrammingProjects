...
int main(void){
    ...
    void testeVariavel (int x); //Iniciamos com duas funções
    ...
    cout << endl << teste; // Aqui printamos o valor da variável teste
...
void testeVariavel(int x){ //Duas funções do tipo void, isto ´s, não retornam nada.
    ...
    cout << endl << x; //Se colocar o print aqui, aí muda o valor dessa função. Aparecem dois num diferentes porque essa variável é uma cópia.
