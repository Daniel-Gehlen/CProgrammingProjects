...
int main(){
    ...
    printf("\nEntre com os numeros paa preencher o vetor, tecle enter a cada numero\n");

    for(i=0; i<N; i++){ //Com um laço for, capturo essesvalores e guardo no vetor
        scanf("%3d", &lista[i]); //com a função scanf capturo numeros inteiros %d e vou armazenando no vetor lista na posição i 
